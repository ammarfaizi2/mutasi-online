            ...
            ?><option value="<?php print $val['username']; ?>"><?php print $val['nama_polres']; ?></option><?php
				...
				<tbody>
					<tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'stnk_preview','stnk', 'stnk_button');" size="10" name="stnk" id="stnk_file" class="btn-warning form-control" req>
                        </td>
					 ...
					 <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'notice_pajak_preview','notice_pajak', 'notice_pajak_button');" size="10" name="notice_pajak" id="notice_pajak_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'ktp_preview','ktp', 'ktp_button');" size="10" name="ktp" id="ktp_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'kwitansi_jual_beli_preview','kwitansi_jual_beli', 'kwitansi_jual_beli_button');" size="10" name="kwitansi_jual_beli" id="kwitansi_jual_beli_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'cek_fisik_preview','cek_fisik', 'cek_fisik_button');" size="10" name="cek_fisik" id="cek_fisik_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'bpkb_preview','bpkb', 'bpkb_button');" size="10" name="bpkb" id="bpkb_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'bukti_pembayaran_pnbp_mutasi_keluar_preview','bukti_pembayaran_pnbp_mutasi_keluar', 'bukti_pembayaran_pnbp_mutasi_keluar_button');" size="10" name="bukti_pembayaran_pnbp_mutasi_keluar" id="bukti_pembayaran_pnbp_mutasi_keluar_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'struk_pelunasan_pajak_preview','struk_pelunasan_pajak', 'struk_pelunasan_pajak_button');" size="10" name="struk_pelunasan_pajak" id="struk_pelunasan_pajak_file" class="btn-warning form-control" req>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="warning">
                                <input type="file" onchange="do_prev(this,'struk_pelunasan_jasa_raharja_preview','struk_pelunasan_jasa_raharja', 'struk_pelunasan_jasa_raharja_button');" size="10" name="struk_pelunasan_jasa_raharja" id="struk_pelunasan_jasa_raharja_file" class="btn-warning form-control" req>
                        </td>
...
var a = ["stnk","notice_pajak", "ktp", "kwitansi_jual_beli", "cek_fisik", "bpkb", "bukti_pembayaran_pnbp_mutasi_keluar", "struk_pelunasan_pajak", "struk_pelunasan_jasa_raharja"],
		...
		for(x in a) {
			...
			b[a[x]].addEventListener("change", func);*/
		}
</script>
</html>