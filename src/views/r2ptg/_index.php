		...
		<form method="post" action="?pg=input_mutasi&post=ok" enctype="multipart/form-data" class="table-responsive">
			<table class="table table-striped table-bordered table-hover table-condensed pwdtable gt">
				...
				<tbody>
					...
					<tr><td class="ia rk active">* Nama Pemilik</td><td colspan="3" class="warning"><input size="50" type="text" readonly value="<?php print $dt['nama_pemilik']; ?>" placeholder="Nama Pemilik" name="nama_pemilik" class="form-control" required></td></tr>
					<tr><td class="ia rk active">* No Rangka</td><td colspan="3" class="warning"><input size="50" type="text" placeholder="No Rangka" readonly value="<?php print $dt['no_rangka']; ?>" name="no_rangka" class="form-control" required></td></tr>
					<tr><td class="ia rk active">* No Mesin</td><td colspan="3" class="warning"><input size="50" type="text" placeholder="No Mesin" readonly value="<?php print $dt['no_mesin']; ?>" name="no_mesin" class="form-control" required></td></tr>
					<tr><td class="ia rk active">* No BPKB</td><td colspan="3" class="warning"><input size="50" type="text" placeholder="No BPKB" readonly value="<?php print $dt['no_bpkb']; ?>" name="no_bpkb" class="form-control" required></td></tr>
					<tr><td class="ia rk active">* No STNK</td><td colspan="3" class="warning"><input size="50" type="text" placeholder="No STNK" name="no_stnk" readonly value="<?php print $dt['no_stnk']; ?>" class="form-control" required></td></tr>
				</tbody>
				<tbody>
					<tr>
